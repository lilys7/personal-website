...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative flex min-h-dvh items-center px-6 pt-16 md:px-10"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-0 overflow-x-clip"
      >
        <div className="absolute bottom-0 right-0 h-[85dvh] opacity-75">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-content flex-col items-center py-24 text-center md:py-32">
        <div className="relative inline-flex flex-col items-center">
          ...
          <PaintedText
            text={SITE.name}
            endAt={0.85}
            className="relative z-10 pt-[0.22em] font-display text-5xl leading-[1.4] font-normal tracking-tight text-ink sm:text-6xl md:text-7xl md:leading-[1.35]"
          />
