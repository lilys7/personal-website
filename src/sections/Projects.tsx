...
const projectCopyClass =
  'mt-5 w-full text-base leading-relaxed text-mute sm:text-lg'
const projectItalicClass =
  'mt-5 w-full text-base italic leading-relaxed text-mute sm:text-lg'
...
function CloakedProject() {
  return (
    <article>
      ...
      <p className={projectCopyClass}>
        Protect your images from deepfakes.
      </p>
      <p className={projectItalicClass}>
        Demo video with web and mobile. Frontend React, HTML/CSS.
      </p>
      <ReflectionNotes learned="The experience of a hackathon! This was my first real, multi-day hackathon (in the past I had only done day-long ones). It definitely gave me the feel of an SF startup founder (sleep deprivation) and taught me how to brainstorm an idea from scratch."
      overcame="We wasted a lot of time trying to come up with an idea, so I think my biggest lesson learned is to think about the idea beforehand and spend the time at the hackathon building, so everyone is working toward the same goal and we stay efficient." />
  ...
  return (
    <article>
      ...
      <p className={projectItalicClass}>
        ...
        took pictures, so you could see the background and recreate it yourself?
        Spotlight does just that.
      </p>
      <ReflectionNotes learned="How to use Figma to create a prototype! Especially how to make an app workflow that is interactive, as I used to assume Figma was just a static mockup. I also learned how to think from a user's ease of use and a business perspective (e.g. retainability, potential for monetization through businesses trying to promote their locations on the app, network effects as more people contribute locations, etc.)."
      overcame="Learning how to format elements. I always wanted to eyeball where my elements were placed by just dragging, dropping, and adjusting, but this was a hassle and caused a lot of formatting issues, especially with elements overlapping. It looked fine on the surface, but one item moving meant everything had to be fixed. I finally learned how to use Auto Layout and fixed the problem." />
...
function PolymarketProject() {
  return (
    <article>
      ...
      <ReflectionNotes learned="What Polymarket was, what traders were, and different terms like book levels, whales, price per volume, etc. I was a complete beginner in this field, but I wanted to gain experience in quantitative trading
      and behavioral finance. There was also a column labeling traders as sharp, good, bad, and awful, and I had just assumed this meant how skilled a trader was: maybe they had more years
      ...
      Soon I learned the rows in the data all correspond to a trader on Polymarket, and different columns detailed things like their trade volume, categories they traded in, profit, etc.
      ...
      I then thought back to what I did at my internship, working with 3D point clouds and density-based machine learning models, and thought that visualizing the Polymarket data in an interactive point cloud would look super cool.
